  ...
  <div className="space-y-6">
    <div className="flex justify-between items-center">
      <Input
        ...
        className="text-5xl font-bold text-foreground bg-transparent border-none hover:bg-secondary/5 focus:bg-secondary/5 transition-colors placeholder:text-foreground max-w-[800px] px-0 h-auto py-3"
        value={title}
