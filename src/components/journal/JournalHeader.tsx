  ...
  <div className="space-y-6">
    ...
    <div className="flex flex-col items-center gap-4">
      <Input
        ...
        className="w-full max-w-2xl text-3xl font-bold text-center bg-transparent border-none hover:bg-secondary/5 focus:bg-secondary/5 transition-colors placeholder:text-muted-foreground/50 overflow-visible"
        value={title}
